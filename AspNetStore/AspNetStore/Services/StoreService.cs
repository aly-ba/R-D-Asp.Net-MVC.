...
namespace AspNetStore.Services
{
    public class StoreService
    {
        ...
        public async Task<IEnumerable<Product>> GetProdcutsForAsync(string category)
        {
        ...
        {
            return await _db.Products.Include("Category").Where(p=>p.ProductId == id).SingleOrDefaultAsync();
        }
